...
public class Controllerw0 implements Initializable {
    ...
    @FXML
    public static Button bntfindfile1;
    @FXML
    public static Button bntfindfile2;
    @FXML
    public static Button bntok;
    @FXML
    public static TextField txtlogin;
    @FXML
    public static TextField txtipset;
    @FXML
    public static TextField txtbiset;
    @FXML
    public static PasswordField idtxtpassdw;
...
//    }
//    @FXML
//    private void bnfindfile1act(ActionEvent event) {
//
...
//    }
//    @FXML
//    private void bnfindfile2act(ActionEvent event) {
//        Controllerw0.txtbiset.setText(filesearch());
//        GlobalVars.FileNameBI = GlobalVars.FileName;
//    }
//
//    @FXML
//    private void bntokact (ActionEvent event) throws IOException {
//        hide this current window (if this is whant you want)
//        ((Node)(event.getSource())).getScene().getWindow().hide();
//
//        GlobalVars.VCenteruser = txtlogin.getText();
//        GlobalVars.Vcenterpassword = idtxtpassdw.getText();
//
